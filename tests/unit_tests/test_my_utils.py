...
class TestMyUtils(unittest.TestCase):
    ...
    def test_non_array_median(self):
        input_non_array = "not an array"
        self.assertRaises(TypeError, my_utils.array_median, input_non_array)
    ...
    def test_non_array_variance(self):
        input_non_array = "not an array"
